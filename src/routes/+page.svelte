...
<svelte:head>
	<title>Timilehin Akinsanmi — Frontend Developer</title>
	<meta
		name="description"
		content="Frontend developer with 5+ years of experience engineering performant, accessible, and visually striking web applications. Explore projects, skills, and get in touch."
	/>
</svelte:head>
